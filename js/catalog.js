...
const CATALOG = [
  ...
  },
  {
    ...
    features: ['Caramelo artesanal', '100g', 'Leche colombiana'],
  ...
  },
  {
    ...
    badge: '🌶️ Atrevido',
    badgeClass: 'spicy',
    description: '75% cacao con extracto de ají colombiano. Para los paladares aventureros que buscan una experiencia única.',
    features: ['75% Cacao', 'Ají colombiano', 'Edición limitada'],
